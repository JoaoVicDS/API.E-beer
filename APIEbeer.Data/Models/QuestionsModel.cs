...
namespace APIEbeer.Data.Models
{
    public class QuestionsModel
    {
        ...
        public string Color { get; set; } = "Qual a cor que você prefere?";
        public string Carbonation { get; set; } = "Qual o nível de carbonatação que você prefere?";
        public string PointOfMeat { get; set; } = "Qual o ponto da carne que você prefere?";
        public string Temperature { get; set; } = "Qual a temperatura que você prefere?";
